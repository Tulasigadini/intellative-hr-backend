...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+asyncpg://doadmin:AVNS_FJnGlyfunhEotJov7rc@intellative-onboard-db-do-user-35952766-0.i.db.ondigitalocean.com:25060/defaultdb?sslmode=require"
    ...
    FRONTEND_URL="https://intellativ-hr-frontend.onrender.com"
